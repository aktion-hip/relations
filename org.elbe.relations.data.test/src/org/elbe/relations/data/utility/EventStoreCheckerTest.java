...
public class EventStoreCheckerTest {
    ...
    public void testCreateAndClear() throws Exception {
        ...
        home.saveEntry(new UniqueID(IItem.TERM, 22));
        assertEquals(1, home.getCount());

        // false means the table exists
        assertFalse(new EventStoreChecker().createEventStoreChecked(new TestEmbeddedCreator()));

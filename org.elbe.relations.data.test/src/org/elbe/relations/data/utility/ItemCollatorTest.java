...
public class ItemCollatorTest {
    ...
    private void assertEqualList(final String[] inArray, final List<IItem> inList) {
        int i = 0;
        for (final IItem lItem : inList) {
            assertEquals(inArray[i++], lItem.toString());
        }
    }

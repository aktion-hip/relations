...
public class TermTest {
	...
	public void testGetLightWeight() throws Exception {
		...
		final LightWeightTerm lLightWeight = (LightWeightTerm) lTerm2
				.getLightWeight();
	...
	public void testSave() throws Exception {
		...
		assertTrue("compare timestamp",
				lStart < ((Timestamp) lTerm.get(TermHome.KEY_MODIFIED))
						.getTime());
	...
	public void testIndexContent() throws Exception {
		...
		assertTrue("contains full 'itemType: 1'",
				lFieldFull.contains("itemType: 1"));
		assertTrue("contains full 'itemTitle: Title'",
				lFieldFull.contains("itemTitle: Title"));
	}
	...
	public void testEquals() throws Exception {
		...
		assertTrue("hashCode equals self",
				lTerm1.hashCode() == lTerm1.hashCode());
		...
		assertEquals("hashCode 1 equals hashCode 3", lTerm1.hashCode(),
				lTerm3.hashCode());
	}

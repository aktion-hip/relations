...
public class RDFaExtractorTest {
    ...
    public final void testProcess() throws Exception {
        XPathHelper lHelper = XPathHelper.newInstance(this.file1.toURI().toURL());
        NewTextAction lAction = RDFaExtractor.process(lHelper,
                this.file1.getAbsolutePath(), this.context);
        ...
        lHelper = XPathHelper.newInstance(this.file2.toURI().toURL());
        lAction = RDFaExtractor.process(lHelper, this.file2.getAbsolutePath(),
                this.context);
        ...
        lHelper = XPathHelper.newInstance(this.file3.toURI().toURL());
        lAction = RDFaExtractor.process(lHelper, this.file3.getAbsolutePath(),
                this.context);

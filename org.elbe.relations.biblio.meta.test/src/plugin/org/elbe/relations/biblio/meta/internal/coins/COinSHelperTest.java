...
public class COinSHelperTest {
    ...
    public void testBook() throws Exception {
        ...
        COinSHelper lHelper = new COinSHelper(COINS_BOOK1, this.context);
        ...
        lHelper = new COinSHelper(COINS_BOOK2, this.context);
        ...
        lHelper = new COinSHelper(COINS_BOOK3, this.context);
        ...
        lHelper = new COinSHelper(COINS_BOOK4, this.context);
    ...
    public void testArticle() throws Exception {
        ...
        COinSHelper lHelper = new COinSHelper(COINS_ARTICLE1, this.context);
        ...
        lHelper = new COinSHelper(COINS_ARTICLE2, this.context);

...
public class ItemTransferDropTargetListener extends AbstractTransferDropTargetListener {
    ...
    public static ItemTransferDropTargetListener create(
        ...
        final ItemTransferDropTargetListener targetListener = new ItemTransferDropTargetListener(
                inViewer, inTransfer);
        ContextInjectionFactory.inject(targetListener, inContext);
        ...
        if (this.editPart != null) {
            ...
            try {
                lHandler.handleDrop(getCurrentEvent().data, DropHelper
                        .getModel((ItemAdapter) this.editPart.getModel(),
                                this.browserManager, this.context), this.context);
            }

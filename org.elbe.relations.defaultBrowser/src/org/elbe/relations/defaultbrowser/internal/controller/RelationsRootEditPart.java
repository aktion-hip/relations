...
public class RelationsRootEditPart extends FreeformGraphicalRootEditPart {
    ...
    /** @param figure The ItemFigure the mouse is over. */
    public void setMouseOverTarget(final ItemFigure figure) {
        this.mouseOverTargetFigure = figure;
    }
    ...
    public void resetMouseOverTarget() {
        this.mouseOverTargetFigure = null;
    }

    /** Makes an item edit part that is child of this edit part clickable.
     *
     * @param clickable boolean <code>true</code> if the child part has to be made clickable. */
    public void makeMousOverPartClickable(final boolean clickable) {
        if (this.mouseOverTargetFigure != null) {
            this.mouseOverTargetFigure.setClickable(clickable);
        }
    }

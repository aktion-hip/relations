 ...
 */
public class RelationEditPart extends AbstractConnectionEditPart implements IBrowserRelation {
    private final IRelation model;

    /** @param relation IRelation */
    public RelationEditPart(final IRelation relation) {
        super();
        this.model = relation;
    }
    ...
    protected void refreshVisuals() {
        ...
        figure.setForegroundColor(getSelected() == SELECTED_NONE ? ColorConstants.black : ColorConstants.red);
    }

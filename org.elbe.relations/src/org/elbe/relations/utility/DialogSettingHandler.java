...
public class DialogSettingHandler {
     ...
     *
     * @param section String the name of the section in the dialog settings.
     * @param term String the name of the term within the section in the dialog settings. */
    public DialogSettingHandler(final String section, final String term) {
        this.dialogSection = section;
        this.dialogTerm = term;
        this.settings = InstanceScope.INSTANCE
                .getNode(RelationsConstants.PREFERENCE_NODE_DIALOG).node(this.dialogSection);
    }
    ...
    public String[] getRecentValues() {
        final String lValues = this.settings.get(this.dialogTerm, ""); //$NON-NLS-1$
    ...
    public void saveToHistory(final String inValue)
        ...
        this.settings.put(this.dialogTerm, flatten(lRecent));
        this.settings.flush();
    }

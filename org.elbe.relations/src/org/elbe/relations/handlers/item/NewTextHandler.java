...
import org.elbe.relations.internal.wizards.TextNewWizard;
import org.elbe.relations.services.IBrowserManager;

/**
 * The handler executed when the <code>new text</code> toolbar button is
 * clicked.
 *
 * @author Luthiger
 */
public class NewTextHandler extends AbastractNewItemHandler {
	...
	public void execute(
		...
		final TextNewWizard lWizard = ContextInjectionFactory
		        .make(TextNewWizard.class, inContext);

...
import org.elbe.relations.internal.wizards.PersonNewWizard;
import org.elbe.relations.services.IBrowserManager;

/**
 * The handler executed when the <code>new person</code> toolbar button is
 * clicked.
 *
 * @author Luthiger
 */
public class NewPersonHandler extends AbastractNewItemHandler {
	...
	public void execute(
		...
		final PersonNewWizard lWizard = ContextInjectionFactory
		        .make(PersonNewWizard.class, inContext);

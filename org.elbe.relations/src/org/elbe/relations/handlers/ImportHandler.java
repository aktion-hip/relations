...
import org.elbe.relations.internal.wizards.e4.ImportWizard;
				...
				new ContextFunction() {
					...
					public Object compute(final IEclipseContext inContext) {
						return ContextInjectionFactory
								.make(org.elbe.relations.internal.wizards.e4.ImportWizardRegistry.class,
										inContext);
					}
				});
		final ImportWizard lWizard = ContextInjectionFactory.make(
				ImportWizard.class, inContext);

...
import org.elbe.relations.internal.wizards.e4.ExportWizard;
				...
				new ContextFunction() {
					...
					public Object compute(final IEclipseContext inContext) {
						return ContextInjectionFactory
								.make(org.elbe.relations.internal.wizards.e4.ExportWizardRegistry.class,
										inContext);
					}
				});
		final ExportWizard lWizard = ContextInjectionFactory.make(
				ExportWizard.class, inContext);

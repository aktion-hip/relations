...
public class QuitHandler {
    ...
    @Execute
    public void execute(final IWorkbench workbench, final IEclipseContext context,
            @Named(IServiceConstants.ACTIVE_SHELL) final Shell shell) {
        if (MessageDialog.openConfirm(shell, RelationsMessages.getString("handler.quit.title"), //$NON-NLS-1$

...
import org.elbe.relations.internal.wizards.DBOpenWizard;

/**
 * Handler to open a database.
 * 
 * @author Luthiger
 */
public class DbOpenHandler {
	...
	public void execute(final IEclipseContext inContext,
		...
		final DBOpenWizard lWizard = ContextInjectionFactory.make(
				DBOpenWizard.class, inContext);

...
/**
 * A light weight model in the Relations application.
 * 
 * @author Luthiger
 */
public interface ILightWeightModel extends ILightWeightItem {

	/**
	 * The icon characteristic of this type of item.
	 * 
	 * @return Image
	 */
	Image getImage();

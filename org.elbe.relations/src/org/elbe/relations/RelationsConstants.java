...
public final class RelationsConstants {
    ...
    private static final String STYLED_TEXT_ITEM = "relations.toolbar:text.styling";
    public static final String STYLED_TEXT_ITEM_BOLD = STYLED_TEXT_ITEM + ".bold"; //$NON-NLS-1$
    public static final String STYLED_TEXT_ITEM_ITALIC = STYLED_TEXT_ITEM + ".italic"; //$NON-NLS-1$
    public static final String STYLED_TEXT_ITEM_UNDERLINE = STYLED_TEXT_ITEM + ".underline"; //$NON-NLS-1$
    public static final String STYLED_TEXT_ITEM_LIST_BULLET = STYLED_TEXT_ITEM + ".list.bullet"; //$NON-NLS-1$
    public static final String STYLED_TEXT_ITEM_LIST_NUMBERED = STYLED_TEXT_ITEM + ".list.number"; //$NON-NLS-1$
    public static final String STYLED_TEXT_ITEM_LIST_UPPER = STYLED_TEXT_ITEM + ".list.chars.upper"; //$NON-NLS-1$
    public static final String STYLED_TEXT_ITEM_LIST_LOWER = STYLED_TEXT_ITEM + ".list.chars.lower"; //$NON-NLS-1$

...
public class RelatedItemHelper {
    ...
    private static KeyObject getKey1(final IItem inItem, final int inType) throws VException {
        final KeyObject outKey = new KeyObjectImpl();
        outKey.setValue(RelationHome.KEY_ITEM2, Long.valueOf(inItem.getID()));
        outKey.setValue(RelationHome.KEY_TYPE2, Integer.valueOf(inItem.getItemType()));
        outKey.setValue(RelationHome.KEY_TYPE1, Integer.valueOf(inType));
        return outKey;
    }

    private static KeyObject getKey2(final IItem inItem, final int inType) throws VException {
        final KeyObject outKey = new KeyObjectImpl();
        outKey.setValue(RelationHome.KEY_ITEM1, Long.valueOf(inItem.getID()));
        outKey.setValue(RelationHome.KEY_TYPE1, Integer.valueOf(inItem.getItemType()));
        outKey.setValue(RelationHome.KEY_TYPE2, Integer.valueOf(inType));
        return outKey;
    }
    ...
    private static List<ItemWithIcon> getItems(final QueryResult inResult,
        ...
        final List<ItemWithIcon> outItems = new ArrayList<>();

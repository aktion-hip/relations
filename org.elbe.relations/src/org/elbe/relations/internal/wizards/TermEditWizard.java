...
/**
 * Wizard to edit a term item, i.e. the item content and the item's relations.
 *
 * @author Luthiger Created on 10.10.2006
 */
@SuppressWarnings("restriction")
public class TermEditWizard extends AbstractEditWizard {
	private TermEditWizardPage page;

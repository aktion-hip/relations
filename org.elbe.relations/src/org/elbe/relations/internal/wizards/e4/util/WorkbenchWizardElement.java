...
public class WorkbenchWizardElement extends WorkbenchAdapter implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.elbe.relations.internal.wizards.util.IWizardDescriptor#getId()
	 */
	@Override
	public String getId() {
		return id;
	...
	public ImageDescriptor getDescriptionImage() {
		if (descriptionImage == null) {
			final String descImage = configuration
					.getAttribute(IWorkbenchRegistryConstants.ATT_DESCRIPTION_IMAGE);
			if (descImage == null) {
				return null;
			}
	...
	public boolean canFinishEarly() {
		return Boolean
				.valueOf(
						configuration
								.getAttribute(IWorkbenchRegistryConstants.ATT_CAN_FINISH_EARLY))
				.booleanValue();
	}
	...
	public IStructuredSelection adaptedSelection(
		...
		final IStructuredSelection adaptedSelection = convertToResources(inSelection);
	...
	private Object createExtension(final IConfigurationElement inElement,
		...
		try {
			...
			throw new CoreException(new Status(IStatus.ERROR,
					Activator.getSymbolicName(), IStatus.ERROR,
					"Cannot create extension", exc));
		}
	}

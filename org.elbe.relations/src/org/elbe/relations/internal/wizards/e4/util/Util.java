...
public final class Util {
	 ...
	 */
	public static Object getAdapter(final Object inSourceObject,
			final Class inAdapterType) {
		...
		if (!(inSourceObject instanceof PlatformObject)) {
			final Object outResult = Platform.getAdapterManager().getAdapter(
					inSourceObject, inAdapterType);
			if (outResult != null) {
				return outResult;
			}
		}

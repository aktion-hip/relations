...
public class DBController implements IDBController {
    ...
    /** Returns the configuration matching the specified name. If no one found with this name, return the default
     * configuration, then the configuration of the first embedded, then the first configuration registered.
     *
    ...
    public IDBConnectionConfig getConfiguration(final int inIndex) {
        return this.dbConfigurations.get(inIndex);
    }
    ...
    public int getSelectedIndex() {
        final String lSelected = this.dbSelection == null || this.dbSelection.isEmpty() ? RelationsConstants.DFT_DBCONFIG_PLUGIN_ID
                : this.dbSelection;

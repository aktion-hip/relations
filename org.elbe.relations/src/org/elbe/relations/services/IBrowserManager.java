...
public interface IBrowserManager {
    ...
    /** @return boolean <code>true</code> if the history contains a previous element */
    boolean hasPrevious();

    /** Moves one step back in the history. */
    void moveBack();

    /** @return boolean <code>true</code> if the history contains a next element */
    boolean hasNext();

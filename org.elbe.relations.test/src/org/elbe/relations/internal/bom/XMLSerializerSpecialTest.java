...
public class XMLSerializerSpecialTest {
    ...
    public void setUp() throws Exception {
        when(this.property.getName()).thenReturn("Text");
        when(this.property.getValue()).thenReturn(TEXT_VAL);
    }
    ...
    public void testVisitProperty() {
        final XMLSerializer serializer = new XMLSerializerSpecial(this.biblioController, this.log);
        serializer.visitProperty(this.property);

...
public class NewTermActionTest {
	...
	public void testExecute() throws Exception {
		...
		final String lTerm = "The End";
		final NewTermAction lAction = new NewTermAction.Builder(lTerm)
		        .build(context);
		lAction.execute();
		...
		assertEquals(lTerm, lModel.get(TermHome.KEY_TITLE));
	}

...
public class BindingElementTest {
    ...
    public void testSetImage() {
        final BindingElement binding = new BindingElement(this.controller);
        final Image image1 = RelationsImages.ITALIC.getImage();
        binding.setImage(image1);
        verify(this.controller).firePropertyChange(binding, "image", null, image1);
        assertEquals(image1, binding.getImage());

        final Image image2 = RelationsImages.BOLD.getImage();
        binding.setImage(image2);
        verify(this.controller).firePropertyChange(binding, "image", image1, image2);
    ...
    public void testSetTrigger() throws Exception {
        ...
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_TRIGGER, null, trigger1);
        ...
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_TRIGGER, trigger1, trigger2);
    ...
    public void testSetContext() throws Exception {
        final BindingElement binding = new BindingElement(this.controller);
        final ContextElement context1 = new ContextElement(this.controller);
        binding.setContext(context1);
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_CONTEXT, null, context1);
        assertEquals(context1, binding.getContext());

        final ContextElement context2 = new ContextElement(this.controller);
        binding.setContext(context2);
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_CONTEXT, context1, context2);
    ...
    public void testSetUserDelta() throws Exception {
        ...
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_USER_DELTA, null, userDelta1);
        assertEquals(userDelta1, binding.getUserDelta());

        final Integer userDelta2 = Integer.valueOf(11);
        binding.setUserDelta(userDelta2);
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_USER_DELTA, userDelta1, userDelta2);
    ...
    public void testSetConflict() throws Exception {
        ...
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_CONFLICT, null, conflict1);
        assertEquals(conflict1, binding.getConflict());

        final Boolean conflict2 = Boolean.TRUE;
        binding.setConflict(conflict2);
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_CONFLICT, conflict1, conflict2);
    ...
    public void testSetCategory() throws Exception {
        ...
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_CATEGORY, null, category1);
        assertEquals(category1, binding.getCategory());

        final String category2 = "aaa";
        binding.setCategory(category2);
        verify(this.controller).firePropertyChange(binding, BindingElement.PROP_CATEGORY, category1, category2);
    ...
    public void testInit1() throws Exception {
        final BindingElement binding = new BindingElement(this.controller);
        this.command = this.commandManager.getCommand("aa");
        final ParameterizedCommand parametrized1 = new ParameterizedCommand(this.command, null);
        ...
        verify(this.controller).firePropertyChange(binding, ModelElement.PROP_MODEL_OBJECT, null, parametrized1);

        this.command.define("cmd name", "Command for testing purpose", this.commandManager.getCategory("test_catgory"));
        final ParameterizedCommand parametrized2 = new ParameterizedCommand(this.command, null);
        ...
        verify(this.controller).firePropertyChange(binding, ModelElement.PROP_MODEL_OBJECT, parametrized1, parametrized2);
    }

    @Test
    public void testInit2() throws Exception {
        final BindingElement bindingModel = new BindingElement(this.controller);
        ...
        final Binding binding1 = createBinding(this.command, "a", KeySequence.getInstance("M1+A"));
        bindingModel.init(binding1, context);
        verify(this.controller).firePropertyChange(bindingModel, ModelElement.PROP_MODEL_OBJECT, null, binding1);
        ...
        this.command.define("cmd name", "Command for testing purpose", this.commandManager.getCategory("test_catgory"));
        final Binding binding2 = createBinding(this.command, "b", KeySequence.getInstance("M1+B"));
        bindingModel.init(binding2, context);
        verify(this.controller).firePropertyChange(bindingModel, ModelElement.PROP_MODEL_OBJECT, binding1, binding2);
    ...
    public void testFill2() throws Exception {
        ...
        final KeyBinding binding1 = createBinding(this.command, "a", KeySequence.getInstance("M1+A"));
        ...
        this.command.define("cmd name", "Command for testing purpose", this.commandManager.getCategory("test_catgory"));
        final KeyBinding binding2 = createBinding(this.command, "b", KeySequence.getInstance("M1+B"));

...
public class RelationsSerializerTest {
	...
	private final static String EXPECTED = ""
	        ...
	        + "<TermEntry>"
	        + NL
	        + "        <ID field=\"TERMID\" type=\"Long\">"
	        + NL
	        + "        </ID>"
	        + NL
	        + "        <Title field=\"STITLE\" type=\"String\">RelationsSerializerTest"
	        + NL
	        + "        </Title>"
	        + NL
	        ...
	        + NL + "        </Text>" + NL
	        + "        <Created field=\"DTCREATION\" type=\"Timestamp\">" + NL
	        + "        </Created>" + NL + "</TermEntry>";
	...
	public void testPrepare() {
		...
		assertEquals(lExpectedPrepared,
		        RelationsSerializer.prepareForExport(lOriginal));
		assertEquals(lOriginal,
		        RelationsSerializer.prepareForImport(lExpectedPrepared));
	}

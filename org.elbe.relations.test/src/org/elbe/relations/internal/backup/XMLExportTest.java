...
public class XMLExportTest {
	...
	public void setUp() throws Exception {
		...
		exportFile = IOUnitils.createTempFile(FILE_NAME);
	}
	...
	public void testExport() throws Exception {
		exporter = new XMLExport(exportFile.getAbsolutePath(), Locale.ENGLISH);
		exporter.export(monitor);
		exporter.close();

		final DocumentBuilder lDocBuilder = DocumentBuilderFactory
		        .newInstance().newDocumentBuilder();
		final Document lDoc = lDocBuilder.parse(exportFile);

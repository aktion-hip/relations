...
public class AbstractPrintOutTest {
    ...
    private static final String XML1 = "<para><b>Dynamic Services (OSGI DS)</b> in Relations-RCP:" + NL
            + "Wenn eine neue Komponente erzeugt worden ist, muss Inhalt von C:/Data/eclipse/workbenches/Relations/.metadata.pluginsorg.eclipse.pde.core/relations.product gel�scht werden (<b>ausser</b> <i>config.ini</i>), damit die neue Komponente vom System erkannt wird.</para>"
            + NL

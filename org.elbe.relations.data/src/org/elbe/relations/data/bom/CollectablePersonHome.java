...
/** Specialized implementation of <code>PersonHome</code> to create <code>LightWeightPerson</code>s.
 *
 * @author Benno Luthiger */
public class CollectablePersonHome extends PersonHome implements ICollectableHome {
     ...
     * @throws SQLException */
    @Override
    public QueryResult select(final QueryStatement statement)
            throws SQLException {

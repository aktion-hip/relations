...
public interface IDBObjectCreator {
    ...
    Collection<String> getCreateStatemens(String xmlName)
            throws IOException, TransformerFactoryConfigurationError, TransformerException;

    /** Returns the SQL statements to create the <code>EventStore</code> table.
     *
     * @param xmlName String name of the XML file specifying the database model.
     * @return Collection<String> of SQL CREATE TABLE/INDEX statements (for the <code>EventStore</code> table only)
     * @throws IOException
     * @throws TransformerFactoryConfigurationError
     * @throws TransformerException */
    Collection<String> getCreateEventStoreStatements(final String xmlName)
            throws IOException, TransformerFactoryConfigurationError, TransformerException;

 ...
 *
 * @author Luthiger Created on 20.11.2008
 */
public class IndexerHelper {
	private Collection<IndexerDocument> documents = new ArrayList<IndexerDocument>();
	...
	/**
	 * Resets the helper, i.e. initializes the documents collection with a new
	 * <code>Collection</code>.
	 */
	public void reset() {
		documents = new ArrayList<IndexerDocument>();
	}
}

...
/**
 * Provides SQL CREATE statemens for the MySQL database.
 *
 * @author Luthiger Created on 09.10.2008
 */
public class MySQLCreator extends AbstractDBObjectCreator implements IDBObjectCreator {
    private static String XSL = "db_mysql.xsl"; //$NON-NLS-1$
